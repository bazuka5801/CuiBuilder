...
namespace Battlehub.UIControls
{
    ...
    public abstract class ItemsControl : MonoBehaviour, IPointerDownHandler, IDropHandler
    {
        ...
        /// <summary>
        /// Raised can item remove
        /// </summary>
        public Func<object,bool> CanItemRemove;
        ...
        public virtual bool CanRemove(object obj)
        {
            if (CanItemRemove == null) return true;
            return CanItemRemove(obj);
        }
        ...
        public void RemoveSelectedItems()
        {
            ...
            selectedItems = selectedItems.Where(CanRemove).ToArray();
